      ...
      <section className="w-full min-h-screen flex flex-col items-center pt-36 text-center relative px-4 md:px-6">
        ...
        <div className="relative space-y-6">
          ...
          <div className="w-full">
            <GlowingButton
              className="w-full h-14 text-lg font-bold bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg hover:opacity-90"
        ...
        <div className="container px-4 md:px-6 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <Badge className="px-3 py-1 bg-indigo-100 text-indigo-700 border-indigo-200 rounded-full">
                Results
              </Badge>
              ...
              <p className="text-gray-500 md:text-xl">
                Our students see an average improvement of 150+ points after
                completing our comprehensive practice program.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Adaptive tests that focus on your weak areas
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Learn proven techniques from 1500+ scorers
                    </p>
                  </div>
                </div>
              </div>
