...
const About = () => {
  return (
    <div>
            ...
            <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                ...
                <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                  Our product will help you prep for the SAT through providing a
                  question bank! You will have annotation and other tools
                  available to aid you in your SAT journey to your dream school
                  🚀
                </p>
              </div>
            </div>
              ...
              <div className="w-full flex-col justify-center items-start gap-8 flex">
                <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                  ...
                  <p className="text-gray-500 text-sm font-normal leading-relaxed lg:text-start lg:text-base text-center">
                    Welcome to DailySAT, your ultimate online resource for
                    mastering the SAT! Our mission is to empower students to
                    achieve their best scores by providing an interactive,
                    personalized, and efficient study experience. Whether
                    you&apos;re aiming for a perfect score or just trying to
                    improve in specific areas, DailySAT is here to guide you
                    every step of the way.
                  </p>
                </div>
                <div className="w-full lg:justify-start justify-center items-center sm:gap-10 space-x-10 inline-flex">
                  <div className="flex-col justify-start items-start inline-flex">
                    <h3 className="text-blue-400 text-4xl font-bold font-manrope leading-normal">
                      70,000+
                    </h3>
                  ...
                  <div className="flex-col justify-start items-start inline-flex">
                    <h4 className="text-blue-400 text-4xl font-bold font-manrope leading-normal">
                      3500+
                    </h4>
                    <h6 className="text-gray-500 text-base font-normal leading-relaxed">
                      SAT Questions
          ...
          <div className="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                ...
                <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                  Schools can easily partner with us and add their names to
                  /schools. Students can then enroll into their schools and
                  teachers can track students progress when they work within the
                  DailySAT platform
                </p>
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLScGb4Pj_Jn1kmAxMVzJ2lCQ5QCyOnOqtGFqvWr9C3RttQlstg/viewform?usp=header"
                  className="rounded-lg font-semibold cursor-pointer bg-blue-500 text-white py-2 px-5"
                >
                  Contact form
                </a>
              </div>
      ...
      <section>
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-blue-900 text-center">
          Workshops:
        </h2>
        <p className="font-light text-gray-500 sm:text-xl text-center">
          We love educating, sharing and learning :) These are workshops
